...
urlpatterns = [
    ...
    path(
        "project/<int:project_id>/add_task/",
        views.add_task_to_project,
    ...
    path(
        "project/<int:project_id>/delete/", views.delete_project, name="delete_project"
    ),
    path(
        "project/<int:project_id>/tasks/<int:task_id>/delete/",
        views.delete_task,
        name="delete_task",
    ),
